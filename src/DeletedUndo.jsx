const DeletedUndo = ({list, setList, undoItem, setUndoItem}) => {
    ...
    return(
        <div className = "fixed bottom-4 left-1/2 -translate-x-1/2 bg-white dark:bg-gray-800 dark:text-white px-6 py-3 rounded-lg shadow-2xl flex items-center gap-4 z-50 animate-fade-in">
